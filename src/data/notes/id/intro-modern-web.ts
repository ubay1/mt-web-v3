...
## Komponen Kunci
1. **Single Page Application (SPA)**: Transisi halaman tanpa reload.
2. **Serverless Functions**: Logika backend yang berjalan secara on-demand.
3. **Optimized Assets**: Gambar dan script yang hanya dimuat saat dibutuhkan.
