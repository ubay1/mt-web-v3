...
## Prinsip Utama
- **Empati pada User**: Jangan hanya fokus pada performa backend, lihat juga sisi client.
- **Efisiensi Sistem**: Minimalkan beban di sisi client dengan optimasi backend yang tepat.
- **Keterhubungan**: Pahami aliran data dari database hingga ke piksel di layar user.
