  ...
  return (
    <>
      ...
      <div className="grid grid-cols-1 md:grid-cols-12">
        ...
        <section
          id="home"
          className="grid-cell md:col-span-8 justify-between min-h-[600px]"
        >
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 items-start">
        ...
        <section
          className="md:col-span-6 cell-border md:sticky md:top-[73px] relative"
        >
        ...
        {/* Contact - Sticky */}
        <section
          className="grid-cell md:col-span-3 bg-accent text-black md:sticky md:top-[73px] relative"
        >
